...
import { aluno, currentLesson, modules, progressStats, project } from "@/lib/mock/aluno";
...
export default function AlunoDashboardPage() {
  ...
  return (
    <AppShell studentName={aluno.firstName}>
      <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6 lg:px-10 lg:py-10">
        <section id="inicio" className="scroll-mt-20">
          ...
          <p className="mt-1.5 text-[15px] text-slate-400">
            Próximo passo: colocar o seu site no ar.
          </p>
        </section>
        ...
        <section
          id="suporte"
          className="scroll-mt-20 mt-8 flex flex-col gap-3 rounded-2xl border border-dashed border-white/10 px-5 py-5 sm:flex-row sm:items-center sm:justify-between"
        >
          <div>
